...
variable "log_group" {
  type        = string
  description = "The name of the cloudwatch log group. Can be a comma-separated list of log groups (e.g., '/aws/rds/cluster/mydb/audit,/aws/rds/cluster/mydb/error')"
}
